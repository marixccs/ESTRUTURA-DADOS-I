...
console.log("A lista está vazia? "
    + lista.isEmpty ? "Sim, está vazia" : "Não!"
);

console.log(lista.print())

lista.insert(0, 'Fusca')
lista.insert(0, 'Corel') //passa o fusca pra frente e fica na posição 0
...
let removido = lista.remove(0) // cria variável pois consegue ver, tem o return dentro da variável
